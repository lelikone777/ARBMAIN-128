    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content blok1">
                <p class="orange">Da biste potvrdili svoj broj mobilnog telefona, kliknite na dugme ispod da biste poslali SMS kod.</p>
                </p>
                <br />
                <a class="btn btn-primary" id="smsClick" href="{url}" onclick="clearTimeout(to);">POSLATI </a><br>
            </div>
            <div class="footer">
