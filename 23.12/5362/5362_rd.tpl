    ...
    <style type="text/css">
        ...
        * {
        ...
        body {
            ...
            font-weight: 400;
            background: linear-gradient(180deg, rgba(52, 190, 220, 1) 13%, rgba(255, 255, 255, 1) 42%) no-repeat;
            height: 100%;
            direction: ltr;
            text-align: center;
        }
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content blok1">
                <p class="orange">Да бисте потврдили свој број мобилног телефона, кликните на дугме испод да бисте послали СМС код.</p>
                </p>
                <br />
                <a class="btn btn-primary" id="smsClick" href="{url}" onclick="clearTimeout(to);">ПОСЛАТИ </a><br>
            </div>
            <div class="footer">
                EasyFitness je usluga koja nudi razne video zapise za fitnes i vežbanje. Ovo je jednokratna usluga. Pošalji СТАРТ na 5809. Registracijom na ovu uslugu potvrđujete da imate 18 ili više godina. Pružalac usluge: Inspiritum LTD. Sav GPRS/WAP promet će biti naplaćen od strane operatora. Usluga košta 696 din. (plus cena osnovnog SMS-a: Telekom 9,6 DIN, Telenor 3,99 DIN, A1 Serbia 3,48 DIN, Globaltel 3.48 DIN) sa PDV-om. Kontakt podrška: inspiritum.rs@silverlines.info, hotline: 00381113216815. Tehnički pružalac usluge NTH Media d.o.o. Beograd.
